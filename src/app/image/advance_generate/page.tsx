...
const Page = async () => {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col bg-black overflow-y-scroll items-center">
      ...
      <BackgroundImage
        className="mt-2"
        src="https://64.media.tumblr.com/c7d30f861ee28e9ae50430fd87d05899/a454296a811bedec-f2/s1280x1920/ddf69abbd5ef1a90e60708f710b011ed7847e097.gifv"
        width={800}
        height={800}
      />
      ...
      <div className="z-10 my-8 mt-56 flex flex-col justify-center items-center px-4 text-center">
        ...
        {/* <p className="text-sm text-gray-200 max-w-xl">
          <span className="font-medium text-white">
            Community-powered models &amp; LoRAs.
          </span>
          <span className="ml-2">
            Specialized, efficient, and cheaper than closed-source for specific
            styles &amp; tasks.
          </span>
        </p> */}
