  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "relative z-[10002] min-w-[8rem] overflow-hidden rounded-2xl border border-[#313131] bg-[#131312] text-[rgba(255,255,255,0.9)] shadow-lg",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className="size-4 text-[rgba(255,255,255,0.72)]" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className="size-4 text-[rgba(255,255,255,0.72)]" />
  </SelectPrimitive.ScrollDownButton>
));
