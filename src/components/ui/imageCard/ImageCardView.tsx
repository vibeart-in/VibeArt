            ...
            {[
              {
                ...
                onClick: () => {
                  ...
                  if (currentPath.startsWith("/generate/edit/")) {
                    ...
                    if ((window as any).nextRouterPush) {
                      (window as any).nextRouterPush(`/generate/edit?image-url=${encoded}`);
                    } else {
                      window.location.href = `${window.location.origin}/generate/edit?image-url=${encoded}`;
                    }
                  }
                },
              },
              {
                ...
                onClick: () => {
                  window.location.href = `${window.origin}/generate/edit?image-url=${encodeURIComponent(mediaUrl)}`;
                },
              },
              {
                label: "Video",
                icon: IconVideo,
                onClick: () => {
                  window.location.href = `${window.origin}/generate/video?image-url=${encodeURIComponent(mediaUrl)}`;
                },
              },
