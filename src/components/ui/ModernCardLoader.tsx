    ...
    <div className="absolute inset-0 z-30 flex flex-col items-center justify-center overflow-hidden bg-black/40 backdrop-blur-md">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -left-[20%] -top-[20%] size-[80%] rounded-full bg-accent/20 blur-[100px]"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
      ...
      <div className="relative z-10 flex flex-col items-center gap-1 px-6 text-center">
        ...
        <motion.p
          ...
          className="text-xs font-light uppercase tracking-widest text-white/80"
        >
          {subtitle}
        </motion.p>
      </div>
      ...
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.1)_50%),linear-gradient(90deg,rgba(255,0,0,0.02),rgba(0,255,0,0.01),rgba(0,0,255,0.02))] bg-[length:100%_4px,4px_100%] opacity-20" />
    </div>
  );
};
