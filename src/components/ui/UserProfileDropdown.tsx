      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-1 z-10 mt-2 flex w-56 flex-col overflow-hidden rounded-2xl border border-white/5 bg-[#0a0a0a]/95 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl"
          >
