  ...
  return (
    <div className="flex shrink-0 items-center gap-1 md:gap-3">
      {navInfo?.subscription_tier === "free" && (
        <Button
          variant="secondary"
          className="hidden h-8 items-center justify-center rounded-xl border border-[#D9E825]/30 bg-black/20 text-xs font-bold leading-4 text-accent shadow-[0px_0px_8px_rgba(217,232,37,0.38)] md:flex"
