  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-1 flex-col px-6 pb-4">
        ...
        <EditorContent
          editor={editor}
          className="nodrag h-full min-h-[120px] w-full cursor-text overflow-auto rounded-xl text-white/90 !outline-none hover:border-0 [&_.ProseMirror]:h-full [&_.ProseMirror]:min-h-[120px] [&_.ProseMirror]:outline-none"
        />
      </div>
    </NodeLayout>
  );
