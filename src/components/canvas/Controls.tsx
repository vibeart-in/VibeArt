...
export default function CustomControls({ nodes, setNodes, minZoom = 0.2, maxZoom = 4 }: Props) {
  ...
  return (
    <div className="pointer-events-auto absolute bottom-4 right-4 z-50 flex items-center gap-3">
      <div
