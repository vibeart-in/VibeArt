...
export default function SideToolbar() {
  ...
  return (
    <>
      ...
      {/* Side Panel */}
      {activePanel && (
        <div className="pointer-events-auto absolute left-20 top-1/2 z-50 w-80 -translate-y-1/2 rounded-2xl border border-white/5 bg-neutral-900/95 shadow-2xl backdrop-blur-md">
  ...
  return (
    <div className="space-y-2">
      ...
      >
        ...
        <div>
          <div className="text-sm font-medium text-white">Image Generator (Advanced)</div>
          <div className="text-xs text-neutral-400">Advanced options and controls</div>
        </div>
      </button>
    </div>
  );
