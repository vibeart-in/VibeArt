          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-5">
               ...
               <div className="flex flex-col gap-3">
                 ...
                 <div className="flex gap-2 translate-y-3 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
  <Button
    className="
      relative
      h-auto px-3
    ...
    onClick={(e) => {
      e.stopPropagation();
      router.push(`/canvas/${template.id}?mode=view`);
    }}
  >
